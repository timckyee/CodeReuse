...
function gridCallbackTable(divTable, response) {
    ...
    row.innerHTML = "<td class=\"underline\"><span id=\"editButton\" style=\"padding: 10px; height: 25px;\">edit<span></td><td><span id=\"fieldPrimaryKey\">1</span></td><td><span id=\"buildingId\">test</span></td>";

    document.getElementById("fieldPrimaryKey").innerHTML = "setting fieldPrimaryKey";
